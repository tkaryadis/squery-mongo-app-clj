(ns cmql-app-clj.js-server-side.ex0-use-js-and-deps
  (:refer-clojure :only [])
...
;;cMQL provide 2 ways to use js-server-code
;;1)cMQL wrappers(see ex1-use-js-wrappers)
;;2)wisp,a Clojurescript like language with js data structures (see ex2-use-wisp)

;;Even if we dont use the 2 above,we still use cMQL to combine dependencies in our js code
...
;;cMQL will use the information on assoc_dissoc_js.deps and combine those function,creating a standalone
