(ns squery-mongo-app-clj.squery.stages.bucketAuto
  (:refer-clojure :only [])
...
(insert :testdb.testcoll [{"price" 500, "category" "A"}
                          {"price" 7500, "category" "A"}
                          {"price" 340, "category" "B"}
                          {"price" 60, "category" "B"}])

(c-print-all (q :testdb.testcoll
                (bucket-auto (into {} [{:k "price" :v :price}
